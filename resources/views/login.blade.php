            ...
            <div class="col-8">
                <div class="login-form main-col text-center p-5 ">
                    ...
                    <form method="POST" onsubmit="return validateForm()"  action="{{route('login')}}">
                        ...
                        <input type="password" name="password" id="password" placeholder='{{ trans('login.password') }}'
                            class="w-100 bg-transparent form-control text-white mb-3">
                        <p id="signinalert"></p>
                        ...
                        <button class="w-100  rounded btn btn-form" id="signupbtn">{{ trans('login.login') }}</button>
                        <p class="text-white pt-4">{{ trans('login.haveNoAccount') }} <a href="{{ url('signup') }}" class="text-white"
                                id="signin">{{ trans('login.signUp') }}</p>
                    </form>
